//Alex Jasper & Lucas Wagler
//Lab 7 - UART, SPI, and WiFi
//9-24-19
//This program sends UART transmissions, receives them, and then displays the received transmission using SPI to a DOGM display.
